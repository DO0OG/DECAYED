...
public class Player_Cam : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        isMove = GameObject.Find("Char").GetComponent<Player_Move>().isMoving;
    ...
    {
        bool onLand = GameObject.Find("Char").GetComponent<Player_Move>().grounded;
    ...
    void HandlePeek()
    {
        ...
        bool isJump = GameObject.Find("Char").GetComponent<Player_Move>().readyToJump;
        bool isSprint = GameObject.Find("Char").GetComponent<Player_Move>().isSprint;
        bool isMove = GameObject.Find("Char").GetComponent<Player_Move>().isMoving;
    ...
    {
        float isSprinting = GameObject.Find("Char").GetComponent<Player_Move>().isSprint ? 1f : 0f;
    ...
    void IdleHeadBob()
    {
        ...
        bool isCrouch = GameObject.Find("Char").GetComponent<Player_Move>().crouched;
